...
class upsRate {
	...
	$data ="<?xml version=\"1.0\"?>  
		...
		curl_close($ch);  
        if ($params['RATINGSERVICESELECTIONRESPONSE']['RESPONSE']['RESPONSESTATUSCODE']) {
            $return = $params['RATINGSERVICESELECTIONRESPONSE']['RATEDSHIPMENT']['TOTALCHARGES']['MONETARYVALUE'];
        } else {
            $return = $params['RATINGSERVICESELECTIONRESPONSE']['RESPONSE']['ERROR']['ERRORDESCRIPTION'];
        }
        
		return array(
		    $params['RATINGSERVICESELECTIONRESPONSE']['RESPONSE']['RESPONSESTATUSCODE'],
		    $return
	    );  
